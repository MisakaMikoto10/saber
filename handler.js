  ...
  async handler(chatUpdate) {
    ...
    try {
      ...
      try {
        ...
        } else global.DATABASE._data.users[m.sender] = {2
          exp: 0,
          uang: 0,
          limit: 10,
          lastclaim: 0,
...
global.dfail = (type, m, conn, usedPrefix) => {
  let msg = {
    rowner: 'Perintah ini hanya dapat digunakan oleh _*Master!1!1!*_',
    owner: 'Perintah ini hanya dapat digunakan oleh _*Master*_!',
    mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
    premium: 'Perintah ini hanya untuk member _*Premium*_ !',
    group: 'Perintah ini hanya dapat digunakan di grup!',
    private: 'Perintah ini hanya dapat digunakan di Chat Pribadi!',
    admin: 'Perintah ini hanya untuk *Admin* grup!',
    botAdmin: 'Jadikan saya sebagai *Admin* untuk menggunakan perintah ini!',
    unreg: `Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama|umur*\n\nContoh: *#daftar Saber|13*`
  }[type]
